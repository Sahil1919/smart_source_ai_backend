    ...
    def get_answers(self, query: str, article_texts: List[str]) -> List[str]:
        ...
        for text in article_texts:
            ...
            try:
                ...
                ans = self.llm.invoke(f"""paragraph: {truncated_text}, question: {query}
                       prompt: Answer the query from paragraph
                       in 30 words if answer is not present there
                       then you can give your own answer""")
                ...
                if "rate_limit_exceeded" in error_msg:
                    try:
                        ...
                        answers.append(f"Could not process this source due to API limitations: {str(e2)[:100]}...")
                else:
